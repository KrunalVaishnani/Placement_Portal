...
namespace Placement_Portal.Areas.Student.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                jobs = await FetchTop10Jobs<Placement_Portal.Areas.Student.Models.JobModel>("Job"),
                TotalJobs = await FetchCountJobs("Job"),
                Companies = await FetchTop10Company<Placement_Portal.Areas.Student.Models.CompanyModel>("Company"),
                TotalCompanies = await FetchCountCompany("Company"),
                Students = await FetchTop10Student<Placement_Portal.Areas.Student.Models.StudentDetailsModel>("Student"),
                TotalStudents = await FetchCountStudent("Student"),
                JobApplications = await FetchTop10JobApplication<Placement_Portal.Areas.Student.Models.JobApplicationModel>("JobApplication"),
                TotalApplications = await FetchCountJobApplication("JobApplication"),
                Users = await FetchTop10User<Placement_Portal.Areas.Student.Models.UserModel>("User"),
